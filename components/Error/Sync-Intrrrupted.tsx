        ...
        <>
            ...
            >
                ...
                <h3 className="text-2xl font-black text-gray-900 mb-2">
                    Sync <span className="text-red-500">Interrupted</span>
                </h3>
                <p className="text-gray-400 font-medium max-w-xs mb-8">
                    We couldn't retrieve the environmental data for this timeframe. Please check your connection.
                </p>
...
export default SyncIntrrrupted
