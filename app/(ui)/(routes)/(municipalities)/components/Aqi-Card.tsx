...
export function AirQualityCard({ station, onCloseAction }: AirQualityCardProps) {
    ...
    const deviceId = station?.id ?? '69e17a4ffe30c98afc221a06';
    ...
    return (
        <Card className="w-full max-w-105 h-full md:h-[70dvh] bg-white text-zinc-900 border-none shadow-[0_-10px_40px_rgba(0,0,0,0.08)] flex flex-col overflow-hidden rounded-t-[2.5rem] md:rounded-[2.5rem]">
