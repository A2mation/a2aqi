                    ...
                    <div className="lg:col-span-5 space-y-8">
                            ...
                            {product.features.map((feature, i) => (
                                <div key={i} className="flex items-center gap-3 p-4 bg-blue-50/50 rounded-2xl border border-blue-100/50">
                                    <div className="w-6 h-6 rounded-full bg-blue-600 flex items-center justify-center">
                                        <Icons.Check className="text-white" size={14} strokeWidth={4} />
                                    </div>
                        ...
                        <div className="flex flex-col gap-4">
                            <Link
                                ...
                                className="w-full flex items-center justify-center gap-3 bg-blue-600 hover:bg-blue-700 text-white font-black py-5 rounded-3xl shadow-xl shadow-blue-200 transition-all active:scale-[0.98]"
                            >
                        ...
                        <div className="p-6 bg-slate-50 rounded-3xl border border-slate-100 space-y-4">
                            <div className="flex justify-between text-sm">
                                ...
                                <span className="text-slate-900 font-black">{product.logistics.delivery}</span>
                            </div>
                            <div className="flex justify-between text-sm">
                                <span className="text-slate-400 font-bold uppercase tracking-wider">Packaging</span>
