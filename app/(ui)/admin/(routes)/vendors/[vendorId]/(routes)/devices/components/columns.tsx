...
import { CalendarDays, Copy, HelpCircle, History, UserCircle, UserMinus } from "lucide-react"
...
export const columns: ColumnDef<Device>[] = [
    ...
    },
    {
        ...
        cell: ({ row }) => {
            ...
            return (
                <Badge
                    className={`capitalize shadow-sm ${statusMap[state] || "bg-secondary text-secondary-foreground"}`}
                >
                    {state.toLowerCase()}
                </Badge>
            )
