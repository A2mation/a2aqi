...
import {
  moderatordeviceSchema,
  ModeratordeviceValues,
} from "@/lib/validation/ModeratorDevice";
  ...
  const mutation = useMutation({
    mutationFn: async (values: ModeratordeviceValues) => {
      const res = await http.post(
        "/api/moderators/devices/register-new-device",
        values,
      );
        ...
        <div className="p-8 bg-slate-900 text-white relative rounded-t-[30px]">
          <div className="relative z-10">
            ...
            <p className="text-slate-400 text-sm mt-1">
              Connect your AQI hardware to the cloud network.
            </p>
          </div>
          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-xs font-black uppercase text-slate-500 tracking-widest">
                      Device Name
                    </FormLabel>
                    <FormControl>
                      <Input
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel className="text-xs font-black uppercase text-slate-500 tracking-widest">
                    Serial Number{" "}
                    <span className="text-red-600">(CAPITAL LETTER)</span>
                  </FormLabel>
                  <FormControl>
