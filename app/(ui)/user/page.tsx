...
import { TeamCollaboration } from "@/components/users-ui/dashboard/Device-Mangement"
        ...
        <div className="flex min-h-screen bg-background">
            ...
            >
                <Header
                    ...
                    actions={
                        <>
                            <Button className="w-full hover:cursor-pointer sm:w-auto h-9 px-4 text-sm font-medium bg-primary text-primary-foreground hover:bg-primary/90 rounded-lg">
                                + Add New Device
                            </Button>
                            <Button
                                variant="outline"
