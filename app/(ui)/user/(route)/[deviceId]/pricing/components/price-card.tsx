...
export function PricingCard({ name, price, period, features, featured }: PricingCardProps) {
    ...
    return (
        <>
            <div className="relative p-6 bg-primary/5 rounded-lg border border-zinc-800">
                {featured && (
                    <div className="absolute right-4 bg-primary text-secondary px-3 py-1 rounded-full text-sm font-medium">
                        Featured
                    </div>
                )}
                <div className="space-y-6">
                    <div>
                        ...
                        <div className="mt-2 flex items-baseline">
                            <span className="text-5xl font-bold tracking-tight text-primary">₹{price}</span>
